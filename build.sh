...
docker run -d -p 9000:9000 --restart=always --name="playland-server-container" --memory-reservation="100m" --memory-swap="600m" --memory="500m" --cpu-period=100000 --cpu-quota=130000 playland-server;
